...
--前提还要选择数据库，user xsxk
dbcc shrinkfile(xsxk,2)


<<<<<<< HEAD

--修改数据库
--增加一个文件组，并增加一个数据文件，指定在这个文件组，增加一个日志文件
alter database b
add filegroup fg1
...
add log file
(name='bs_log',
filename='H:\data\bs_log.ldf',
size=10mb,
filegrowth=10%)
=======
dbcc shrinkfile(course,10)
>>>>>>> 768432280dfd9120070db615807eb51441230f38
...
姓名 char(8) not null,
性别 bit ,
学历 varchar(20) check(学历='专科'or 学历='本科'or 学历='硕士研究生'or 学历='博士研究生'),
职称 varchar(8) check(职称='助理讲师' or 职称='讲师'or 职称='副教授'or 职称='教授')
)


--软件里约束格式
([学历]='专科' OR [学历]='本科' OR [学历]='硕士研究生' OR [学历]='博士研究生')
...
课程名 varchar(40) not null unique,
学时 tinyint check(学时>36 and  学时>80),
学分 decimal(3,1) not null check(学分>1.0 and 学分<4.0),
授课教师 char(4) not null foreign key references 教师(工号)
) 


--创建选课表，外键的数据类型必须必须跟主键表一样
 create table 选课
 (课程号 tinyint not null  foreign key references 课程(课程号) ,
...
对象资源管理器”窗口中，展开“数据库”→“学生选课”→“数据库关系图”，右击，“新建数据库关系图”，添加“学生选课”数据库中的所有用户表（“选课”、“教师”、“课程”、“学生”表），因为“学生选课”数据库中表之间已经建立了关系，可以看到“学生选课”数据库表的依赖关系。

![1569545990074](images/44.2.png)

![1569546582401](images/44.3.png)

![1569546660457](images/44.4.png)

这里要下拉选择好

![1569547369634](images/44.7.png)

导出数据最好是将text改为varchar